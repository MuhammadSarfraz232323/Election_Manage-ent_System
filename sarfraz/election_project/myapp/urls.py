...
urlpatterns = [
    ...
    path('Admin/complete_data/',complete),
    path('contact/',contact_page),
    path('watch_video/',watch_video),
    path('cast_vote/cast_vote/<int:id>/',vote_casting,name="vote-casting"),
    path('cast_vote/cast_vote/<int:id>/send_detail/',detail),
